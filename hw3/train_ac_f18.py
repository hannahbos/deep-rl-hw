...
class Agent(object):
    ...
    def estimate_advantage(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        V_ob = self.sess.run(self.critic_prediction, feed_dict={self.sy_ob_no: ob_no})
        adv_n = re_n + (1-terminal_n)*self.gamma*V_next_ob - V_ob
    ...
    def update_critic(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        for i in range(self.num_target_updates):
            V_next_ob = self.sess.run(self.critic_prediction, feed_dict={
                                     self.sy_ob_no: next_ob_no})
            target = re_n + (1 - terminal_n) * self.gamma * V_next_ob
